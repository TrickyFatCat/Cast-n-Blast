...
ds_map_add(KamikazeData, EnemyParameter.Scores,				20);
...
ds_map_add(ImpData, EnemyParameter.Scores,				30);
...
ds_map_add(DemonData, EnemyParameter.Scores,				70);
...
ds_map_add(CrystalData, EnemyParameter.Scores,				100);
...
ds_map_add(BomberData, EnemyParameter.Scores,				150);
...
ds_map_add(MageData, EnemyParameter.Scores,				170);
...
ds_map_add(EvolvedImpData, EnemyParameter.Scores,				200);
...
ds_map_add(ShamanData, EnemyParameter.Scores,				200);
...
ds_map_add(EvolvedDemonData, EnemyParameter.Scores,					250);
...
ds_map_add(NinjaData, EnemyParameter.Scores,				250);
