...
ds_map_add(DemonData, EnemyParameter.MaxHitPoints,			100);
ds_map_add(DemonData, EnemyParameter.MaxVelocity,			1);
ds_map_add(DemonData, EnemyParameter.Scores,				8);
...
ds_map_add(NinjaData, EnemyParameter.MaxHitPoints,			100);
...
ds_map_add(NinjaData, EnemyParameter.ShieldPointsDrop,		1);
...
ds_map_add(ShamanData, EnemyParameter.MaxHitPoints,			50);
...
ds_map_add(ShamanData, EnemyParameter.ShieldPointsDrop,		4);
ds_map_add(ShamanData, EnemyParameter.UltimatePointsDrop,	3);
#endregion

#region Bomber
BomberData = ds_map_create();
ds_map_add(BomberData, EnemyParameter.MaxHitPoints,			200);
...
ds_map_add(BomberData, EnemyParameter.ShieldPointsDrop,		5);
