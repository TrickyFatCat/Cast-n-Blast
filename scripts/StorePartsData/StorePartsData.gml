...
ds_map_add(Legs0Data, "repairCost",		25);
...
ds_map_add(Legs1Data, "repairCost",		30);
...
ds_map_add(Legs2Data, "repairCost",		35);
...
ds_map_add(Legs3Data, "repairCost",		40);
...
ds_map_add(Legs4Data, "repairCost",		45);
...
ds_map_add(Legs5Data, "repairCost",		50);
...
ds_map_add(Case0Data, "repairCost",		25);
...
ds_map_add(Case1Data, "repairCost",		30);
...
ds_map_add(Case2Data, "repairCost",		35);
...
ds_map_add(Case3Data, "repairCost",		40);
...
ds_map_add(Case4Data, "repairCost",		45);
ds_map_add(Case4Data, "upgradeCost",	100);

// Case level 5
Case5Data = ds_map_create();
ds_map_add(Case4Data, "maxHitPoints",	50);
ds_map_add(Case4Data, "effectiveness",	1.5);
ds_map_add(Case4Data, "repairCost",		50);
ds_map_add(Case4Data, "upgradeCost",	120);
...
ds_map_add(Weapon4Data, "maxHitPoints",	200);
ds_map_add(Weapon4Data, "effectiveness",2);
ds_map_add(Weapon4Data, "repairCost",	600);
ds_map_add(Weapon4Data, "upgradeCost",	600);

// Case level 5
Weapon5Data = ds_map_create();
ds_map_add(Weapon5Data, "maxHitPoints",	200);
ds_map_add(Weapon5Data, "effectiveness",2);
ds_map_add(Weapon5Data, "repairCost",	600);
ds_map_add(Weapon5Data, "upgradeCost",	600);
